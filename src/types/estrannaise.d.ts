declare module "estrannaise/src/models.js" {
	...
	export function PKFunctions(
		conversionFactor?: number,
	): Record<string, (...args: unknown[]) => number>;
	export function PKRandomFunctions(
		conversionFactor?: number,
	): Record<string, (...args: unknown[]) => number>;
	...
	export function fillCurve(
		func: (...args: unknown[]) => number,
		xMin: number,
		xMax: number,
		nbSteps: number,
	): object;

	export const modelList: Record<
		string,
		{ units: string; description: string }
	>;
	export const PKParameters: Record<string, number[]>;
	export const availableUnits: Record<
		string,
		{ units: string; conversionFactor: number; precision: number }
	>;
}
